...
//
//import com.yzwy.admin.security.UrlSecurityInterceptor;
//import com.yzwy.admin.security.UserDetailService;
...
//
//    @Value("${remember.key}")
//    private String key = "weixin:yzwy_com";
//
//
//    @Bean
...
//        http.logout().logoutRequestMatcher(new AntPathRequestMatcher("/logout")).logoutSuccessHandler(new LogoutSuccessHandler());
